    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
              <?php
                  ...
                  ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                  <button class="btn btn-default" type="button">Rs. <?php echo $value["vp_cost"]; ?> /-&nbsp;<span class="badge">INR</span></button>
                                    <button class="btn btn-primary btnAddToCart" data-id="<?php echo $value["vpid"]; ?>" type="button"><i class="fa fa-plus-circle"></i> Add to cart</button>
                                </div>
                            </div>
          ...
          <div class="panel-footer">
              <a href="<?php echo site_url('site/premium_videos'); ?>" class="no_anchor_decoration">Click here to browse all packages</a>
          </div>
        </div>
